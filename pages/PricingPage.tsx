    ...
    <div className="grid gap-8 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-3 grid grid-cols-4 gap-2">
          {[1, 2, 3, 4].map((n) => <div key={n} className="h-20 rounded-lg bg-gray-200" />)}
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>Built for urban life</li><li>Lightweight but strong</li><li>Perfect gift</li>
        </ul>
        ...
        <a href="#/corporate" className="mt-6 inline-block rounded-full bg-black px-6 py-3 font-semibold text-white">Customize for Your Brand</a>
      </div>
    </div>
  </section>
);
